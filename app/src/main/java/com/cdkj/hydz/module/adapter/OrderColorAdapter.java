...
public class OrderColorAdapter extends RecyclerView.Adapter<OrderColorAdapter.ViewHolder> {

    private Context mContext;
    private ArrayList<OrderCraftModel> mData;

    public OrderColorAdapter(Context mContext, ArrayList<OrderCraftModel> data) {
        this.mData = data;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // 实例化展示的view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_order_color, parent, false);
        // 实例化viewholder
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.txtBorder.setOnClickListener(view -> {
            if(!mData.get(position).isSelect()){
                ...
                model.setEventBusTag(EventTags.COLOR);
