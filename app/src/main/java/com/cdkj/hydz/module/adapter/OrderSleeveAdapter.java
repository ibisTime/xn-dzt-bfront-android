...
public class OrderSleeveAdapter extends RecyclerView.Adapter<OrderSleeveAdapter.ViewHolder> {

    private Context mContext;
    private ArrayList<OrderCraftModel> mData;

    public OrderSleeveAdapter(Context mContext, ArrayList<OrderCraftModel> data) {
        this.mData = data;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.txtBorder.setOnClickListener(view -> {
            if(!mData.get(position).isSelect()){
                ...
                model.setEventBusTag(EventTags.SLEEVE);
